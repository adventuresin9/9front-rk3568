...
mpinit(void)
{
	...
	//	print("mpinit: %d = %llux\n", i, sysrd(MPIDR_EL1));
		...
		u.r1 = (sysrd(MPIDR_EL1) & ~0xFF00) | i<<8;		/* A55 uses AFF1 for cores */
		u.r2 = PADDR(_start);
		u.r3 = i;
		smccall(&u);
	}
...
cpuidprint(void)
{
	iprint("cpu%d: %dMHz ARM Cortex A55\n", m->machno, m->cpumhz);
}
...
//intrcpushutdown();
	...
	b32 = *(u32int*)(VIRTIO + GICD);
	print("GICD_CTLR= _%ulX\n", b32);
//	b32 |= ~(1<<4 | 1<<1);
//	*(u32int*)(VIRTIO + GICD) = b32;

//	while(*(u32int*)(VIRTIO + GICD) & (1<<31))
//		;

	b32 = *(u32int*)(VIRTIO + (GICD + 0x4));
	print("GICD_TYPER= _%ulX\n", b32);
//	b32 = *(u32int*)(VIRTIO + (GICD + 0x8));
//	print("GICD_IIDR= _%ulX\n", b32);
	b64 = *(u32int*)(VIRTIO + (GICR + 0x8));
	print("GICR_TYPER0= _%ullX\n", b64);
	b64 = *(u32int*)(VIRTIO + (GICR + 20000 + 0x8));
	print("GICR_TYPEr1= _%ullX\n", b64);
	b64 = *(u32int*)(VIRTIO + (GICR + 40000 + 0x8));
	print("GICR_TYPER2= _%ullX\n", b64);
	b64 = *(u32int*)(VIRTIO + (GICR + 60000 + 0x8));
	print("GICR_TYPER3= _%ullX\n", b64);
	b64 = *(u32int*)(VIRTIO + (GICR + 80000 + 0x8));
	print("GICR_TYPER4= _%ullX\n", b64);
	b64 = *(u32int*)(VIRTIO + (GICR + 100000 + 0x8));
	print("GICR_TYPER5= _%ullX\n", b64);




//	b32 = *(u32int*)(VIRTIO + (GICR + 0x4));
//	print("GICR_IIDR= _%ulX\n", b32);
}
