...
//#define	UARTOUT		0xC11084C0
//#define	VUARTOUT	0xC11084C0

//#define PHYSCONS	(0xFFFFFF00FF1A0000ULL)
//#define	PHYSCONS	(VIRTIO + UART2)
//#define	UARTOUT		0xFF1A0000	/* uart2 on the ROCKPro64 */
//#define	VUARTOUT	(0xFFFFFF00FF1A0000ULL)

//#define PHYSCONS	(0xFFFFFF00FDD50000ULL)
#define	PHYSCONS	(VIRTIO + UART2)
#define	UARTOUT		0xFE660000	/* uart2 on the Odroid M1 */
#define	VUARTOUT	(0xFFFFFF00FE660000ULL)

#define	UART0OUT	0xFDD50000
#define	UART1OUT	0xFE650000
#define	UART2OUT	0xFE660000
#define	UART3OUT	0xFE670000
...
/* mmio is up at 0xF0000000 on the rk3568, putting ucram just below that */
/* padding with a page on each side */
#define	UCRAMBASE	(0xF0000000 - BY2PG - UCRAMSIZE - BY2PG)
#define	UCRAMSIZE	(8*MiB)

#define VDRAM		(0xFFFFFFFFC0000000ULL)	/* 0x40000000 - 0x80000000 */
#define	KTZERO		(VDRAM + 0x2000000)	/* kernel text start */

#define	PHYSDRAM	0
#define	DRAMSIZE	0xE0000000


#define PHYSIO		0xF8000000
#define IOSIZE		0x07FD0000
#define	VIRTIO		(0xFFFFFF0000000000ULL)


#define	KZERO		(0xFFFFFFFFC0000000ULL)	/* 0x00000000 - kernel address space */
...
#define CONFADDR	(VDRAM + 0x1900000)
